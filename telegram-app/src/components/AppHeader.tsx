...
export function AppHeader() {
  return (
    <header className="sticky top-0 z-[2] w-full backdrop-blur-md transition-colors border-b border-[var(--tgui--outline)] bg-[var(--tgui--bg_color)]/95 pt-[max(env(safe-area-inset-top,0px),var(--tg-safe-area-inset-top,0px))]">
